...
import { sendOTP, verifyOTP as verifyStandaloneOTP } from '../controllers/otpController.js';
import { authRateLimiter, passwordResetRateLimiter, otpRateLimiter, resendOTPRateLimiter } from '../utils/rateLimiter.js';
...
// Resend OTP (rate limited: max 3 per hour)
