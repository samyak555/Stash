...
const Logo = ({ size = 'default', className = '', showText = true, fullPage = false }) => {
  ...
  if (fullPage) {
    return (
      <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-0" style={{ opacity: 0.2 }}>
        <img
          src="/logo.png"
          alt="Stash"
          ...
          style={{ 
            ...
            width: 'auto',
            height: 'auto',
            filter: 'drop-shadow(0 0 200px rgba(59, 130, 246, 0.6))'
          }}
          onError={(e) => {
