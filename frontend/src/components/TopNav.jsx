...
/**
 * Top Navigation Bar
 * - Shows auth buttons/profile dropdown in top-right
 * - Replaces floating guest banner
 */
const TopNav = ({ user, setUser }) => {
  ...
  // Guest mode - show subtle sign in button
  if (isGuest) {
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-end h-12 md:h-14">
            <button
              ...
              className="px-3 py-1.5 text-xs md:text-sm font-medium text-text-secondary hover:text-text-primary bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-all flex items-center gap-1.5"
            >
